        ...
        return (
            <>
                <MenuBox >
                        ...
                        <a className="navButton" target="_blank" rel="noreferrer" href={Curriculum}>Curriculum</a>
                    ...
                    <MenuBoxDropDown see={onOpen} >
                        ...
                        <a className="navDropButton" onClick={toggleMenu} target="_blank" rel="noreferrer" href={Curriculum}>Curriculum</a>
